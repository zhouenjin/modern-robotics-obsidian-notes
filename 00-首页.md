...
> [!summary]
> 这套笔记按课程前七章重写，目标是服务于 Obsidian 中的长期听课记录与阶段复习，而不是只做题。结构遵循课程原始章节顺序，并把每章的主线、核心概念、关键公式、章节衔接和常见误区放在同一页里。
...
9. [[08-第7章 Kinematics of Closed Chains/第7章 Kinematics of Closed Chains：闭链运动学]]
10. [[99-附录与速查/符号约定、公式写法与章节速查]]
...
flowchart TD
    ...
    E --> F["第6章 Inverse Kinematics: 已知末端目标, 如何反求关节变量"]
    F --> G["第7章 Kinematics of Closed Chains: 闭链里的位姿、速度、力与奇异点"]
```
...
- 第 7 章：[[08-第7章 Kinematics of Closed Chains/第7章 Kinematics of Closed Chains：闭链运动学]]
...
- 第 7 章闭链运动学：[[08-第7章 Kinematics of Closed Chains/第7章 Kinematics of Closed Chains：闭链运动学]]
